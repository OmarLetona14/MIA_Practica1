...
class ConsultaController{
    ...
    public async getConsulta1(req:Request, res:Response){
        await pool.query(`select d.nombre, d.telefono, max(o.cantidad*p.precio_unitario) as total from compra as c
    ...
    public async getConsulta2(req:Request, res:Response){
        await pool.query(`select v.idCliente, d.nombre as total_compra, count(o.cantidad) as compras from venta as v
    ...
    public async getConsulta3(req:Request, res:Response){
        await pool.query(`(select u.direccion, u.region, u.ciudad, u.codigo_postal, count(idOrden) as ordenes from venta as v 
        inner join cliente as c on c.idCliente = v.idCliente
    ...
    public async getConsulta4(req:Request, res:Response){
        await pool.query(`select c.idCliente, d.nombre, count(v.idOrden) as ordenes, sum(p.precio_unitario*o.cantidad) as total from venta as v
    ...
    public async getConsulta5(req:Request, res:Response){
        await pool.query(`(select date_format(c.fecha_registro, '%m') as Mes_registrado, d.nombre, sum(p.precio_unitario*o.cantidad) as total from venta as v
        inner join orden as o on o.idOrden = v.idOrden
        inner join producto as p on p.idProducto = o.idProducto
        inner join cliente as c on c.idCliente = v.idCliente
        inner join dato as d on d.idDato = c.idDato
    ...
    public async getConsulta6(req:Request, res:Response){
        await pool.query(`(select c.nombre_categoria, sum(o.cantidad*p.precio_unitario) as total_vendido , count(c.idCategoria_producto) as cantidad_vendida from venta as v
        inner join orden as o on o.idOrden = v.idOrden
        inner join producto as p on p.idProducto = o.idProducto
    ...
    public async getConsulta8(req:Request, res:Response){
        await pool.query(`(select u.direccion, u.region, u.ciudad, u.codigo_postal, sum(o.cantidad*pr.precio_unitario) as total_comprado from venta as v
        inner join cliente as c on c.idCliente = v.idCliente
        inner join ubicacion as u on u.idUbicacion = c.idUbicacion
        inner join orden as o on o.idOrden = v.idOrden
        inner join producto as pr on pr.idProducto = o.idProducto
    ...
    public async getConsulta9(req:Request, res:Response){
        await pool.query(`select d.nombre, d.telefono, o.idOrden, (o.cantidad*pr.precio_unitario), o.cantidad as total from compra as c
